...
public class Motor{
    ...
    public void createAllPokemon(){
        ...
        pokemon nidoranF = new pokemon("veneno", "NidoranF", smog, sludge, null, null, 1, 4, nidorina, 5, 0);
        allPokemon.add(nidoranF);
        ...
        pokemon nidoranM = new pokemon("veneno", "NidoranM", smog, poisongas, null, null, 1, 4, nidorino, 5, 0);
        ...
        pokemon zulbat = new pokemon("veneno", "Zulbat", acid, sludge, null, null, 1, 4, golbat, 5, 0);
        allPokemon.add(zulbat);
        ...
        pokemon arcanine = new pokemon("fuego", "Arcanine", ember, fireblast, flamethrower, firespin, 3, 10, null, 10, 0);
