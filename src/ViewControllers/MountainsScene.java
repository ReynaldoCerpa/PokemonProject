...
public class MountainsScene {
    ...
    public void startWildFight(MouseEvent mouseEvent) {
        Random random = new Random();

        int probability = random.nextInt(2);
        if (probability!=1) {
            motor.showWildFight(mouseEvent);
    ...
    public void openMapButton(MouseEvent mouseEvent) {
        motor.showMap(mouseEvent);
    }

    public void enterPokemartButton(MouseEvent mouseEvent) {
        motor.showPokemart(mouseEvent);
    }

    public void enterGymButton(MouseEvent mouseEvent) {
        motor.showGymFight(mouseEvent);
    }
