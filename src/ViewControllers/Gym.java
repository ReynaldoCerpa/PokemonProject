...
public class Gym {
    ...
    public void clearHabilityLabels(){
        //resets pokemon hability in fight in order to prevent 4hbility pokemons habilities overlapping
        habilityLabel1.setVisible(false);
        hability1Button.setVisible(false);
        habilityLabel2.setVisible(false);
        hability2Button.setVisible(false);
        habilityLabel3.setVisible(false);
        hability3Button.setVisible(false);
        habilityLabel4.setVisible(false);
        hability4Button.setVisible(false);
    }
